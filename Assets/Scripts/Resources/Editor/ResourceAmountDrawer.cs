...
namespace Resources {
    ...
    public class ResourceAmountDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            ...
            var resource = (Resource)EditorGUI.ObjectField(new Rect(position.x+EditorGUIUtility.labelWidth+width*0.3f, position.y, width*0.7f, position.height), resourceAmount.resourceType, typeof(Resource), false);
